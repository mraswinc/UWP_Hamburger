...
using UWP_Hamburger.Controls;
using UWP_Hamburger.Pages;
...
namespace UWP_Hamburger
{
    ...
    public sealed partial class AppShell : Page
    {
        ...
        private void BackRequested(ref bool handled)
        {
            ...
            string pagename = this.AppFrame.Content.GetType().Name;
        ...
        {
            this.AppFrame.Navigate(typeof(Profile), e.OriginalSource, new Windows.UI.Xaml.Media.Animation.DrillInNavigationTransitionInfo());
        }
    }
}
